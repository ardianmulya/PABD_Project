...
{
    public partial class SUPIR : Form
    {
        ...
        private void SUPIR_Load(object sender, EventArgs e)
        {
            LoadTheme();
            Lihatdata();
        }
        ...
        private void Add_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                SqlCommand check = new SqlCommand("select ID_supir from dbo.Supir Where ID_supir = '" + (textBox1.Text) + "'", conn);
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("insert into dbo.Supir (ID_supir,Nama_supir,No_TLP,usia)values(@ID,@nama,@no_tlp,@usia)", conn);
                    ...
                    cmd.Parameters.Add(new SqlParameter("@usia", Convert.ToInt32(textBox4.Text)));
                    cmd.ExecuteNonQuery();
        ...
        private void Delete_Click(object sender, EventArgs e)
        {
            ...
            else if (textBox1.Text != "")
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("delete dbo.Supir where ID_supir = '" + (textBox1.Text) + "'", conn);
                    cmd.ExecuteNonQuery();
                    conn.Close();
            ...
            {
                MessageBox.Show("ISI ID_supir yang akan dihapus");
            }
        }
        ...
        private void Search_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string str = "select * from dbo.Supir Where ID_supir = '" + (textBox1.Text) + "'";
                SqlDataAdapter da = new SqlDataAdapter(str, conn);
                DataSet ds = new DataSet();
                da.Fill(ds);
                dataGridView1.DataSource = ds.Tables[0];
            ...
            {
                MessageBox.Show("ISI ID_supir yang akan dicari");
            }
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                textBox2.Text = row.Cells["Nama_supir"].Value.ToString();
                textBox3.Text = row.Cells["No_TLP"].Value.ToString();
                textBox4.Text = row.Cells["usia"].Value.ToString();
            }
        }
        ...
        private void Update_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("update dbo.Supir set Nama_supir = '" + textBox2.Text + "',No_TLP = '" + textBox3.Text + "',usia='" + textBox4.Text + "'where ID_supir = '" + (textBox1.Text) + "'", conn);
                    cmd.ExecuteNonQuery();
                    conn.Close();
