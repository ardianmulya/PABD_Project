...
namespace PABD_Project.Relasi
{
    public partial class REGISTRASI : Form
    {
        ...
        {
            conn.Open();
            string str = "select * from dbo.Registrasi";
        ...
        {
            conn.Open();
            SqlCommand check = new SqlCommand("select ID_registrasi from dbo.Registrasi Where ID_registrasi = '" + (textBox1.Text) + "'", conn);
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("insert into dbo.Registrasi (ID_registrasi,tanggal_pendaftaran,ID_penyewa,ID_petugas)values(@ID,@tanggal,@penyewa,@petugas)", conn);
                ...
                cmd.Parameters.Add(new SqlParameter("@penyewa", textBox3.Text.ToString()));
                cmd.Parameters.Add(new SqlParameter("petugas", textBox4.Text.ToString()));
                cmd.ExecuteNonQuery();
        ...
        private void Delete_Click(object sender, EventArgs e)
        {
            ...
            else if (textBox1.Text != "")
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("delete dbo.Registrasi where ID_registrasi = '" + (textBox1.Text) + "'", conn);
                    cmd.ExecuteNonQuery();
                    conn.Close();
            ...
            {
                MessageBox.Show("ISI ID_registrasi yang akan dihapus");
            }
        }
        ...
        private void Search_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string str = "select * from dbo.Registrasi Where ID_registrasi = '" + (textBox1.Text) + "'";
                SqlDataAdapter da = new SqlDataAdapter(str, conn);
                DataSet ds = new DataSet();
                da.Fill(ds);
                dataGridView1.DataSource = ds.Tables[0];
            ...
            {
                MessageBox.Show("ISI ID_registrasi yang akan dicari");
            }
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                textBox1.Text = row.Cells["ID_registrasi"].Value.ToString();
                dateTimePicker1.Text = row.Cells["tanggal_pendaftaran"].Value.ToString();
                textBox3.Text = row.Cells["ID_penyewa"].Value.ToString();
                textBox4.Text = row.Cells["ID_petugas"].Value.ToString();
            }
        }
        ...
        private void Update_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("update dbo.Registrasi set tanggal_pendaftaran = '" + dateTimePicker1.Value + "',ID_penyewa = '" + textBox3.Text + "',ID_petugas='" + textBox4.Text + "'where ID_registrasi = '" + (textBox1.Text) + "'", conn);
                    cmd.ExecuteNonQuery();
                    conn.Close();
